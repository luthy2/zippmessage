...
class Activity(db.Model):
	owner_id = db.Column(db.Integer, db.ForeignKey('user.id'), foreign_keys='User.activity_feed', primary_key = True) #index for construction of feeds
	subject_id = db.Column(db.Integer, db.ForeignKey('user.id'), foreign_keys="User.actions_created", primary_key=True) #who performed the action
